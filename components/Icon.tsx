...
const paths: Record<IconName, React.ReactNode> = {
  ...
  chat: (
    <>
      <path d="M20.5 11.6c0 3.9-3.8 7.1-8.5 7.1-.93 0-1.83-.12-2.66-.35L4 20.5l1.2-3.3C3.55 15.85 2.5 13.85 2.5 11.6 2.5 7.7 6.3 4.5 11 4.5s9.5 3.2 9.5 7.1z" />
      <path d="M8.5 10.4h6M8.5 13.4h3.6" />
    </>
  ),
  upvote: (
    <>
      <path d="M12 4.5l6.5 7h-3.6v8h-5.8v-8H5.5l6.5-7z" />
    </>
  ),
  route: (
    <>
